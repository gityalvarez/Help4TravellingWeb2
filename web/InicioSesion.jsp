...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            String registrar=(String)session.getAttribute("registra");
            ...
            <% String nick = "\"" + session.getAttribute("nickname").toString() + "\"";
                ...
                //$("#nickname_ingreso").attr("readonly", true);
                //$("#password_ingreso").attr("readonly", true);
                ...
                <div class="col-md-4" id="registro_usuario" >
                    ...
                    <form role="form"  class="form"  action="Registro" method="post" id="registro_completo_form" >
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="password2_in" placeholder="Reingrese el Password" type="password">
                        </div>
                        <div class="form-group">
                            <label>Nombre</label>
